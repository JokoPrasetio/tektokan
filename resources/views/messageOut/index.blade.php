...
<div class="container-xl mt-5 px-4">
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="container">
                <table class="table small table-striped table-hover" id="data_message_out"></table>
            </div>
        </div>
    </div>
</div>
@include('Dashboard.messageIn.modals.add')
    <script src="/js/message/messageOut/_init.js"></script>
    <script src="/js/message/messageOut/dt.js"></script>
@endsection
